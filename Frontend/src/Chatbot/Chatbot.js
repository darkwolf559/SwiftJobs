...
const Chatbot = ({ apiKey }) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        id: Date.now() + 1,
        text: `Error: ${error.message || "Unknown error"}. Please check your API key and network connection.`,
        sender: 'bot',
        isError: true,
      };
      ...
      >
        {messages.length === 0 && (
          <View style={styles.emptyStateContainer}>
            ...
            <Text style={styles.emptyStateText}>Ask me anything and I'll do my best to help you.</Text>
          </View>
        )}
